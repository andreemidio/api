    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(help_text='Informe seu nome', max_length=255, verbose_name='Nome')),
                ('sobrenome', models.CharField(help_text='Informe seu sobrenome', max_length=255, verbose_name='Sobrenome')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cpf_ou_cnpj', models.CharField(blank=True, max_length=255)),
                ('celular', models.CharField(blank=True, max_length=255)),
                ('resultado_consultas', models.TextField(blank=True)),
                ('documento_identificacao', models.BinaryField(blank=True)),
                ('selfie_usuario', models.BinaryField(blank=True)),
                ('comprovante_residencia', models.BinaryField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_consulta', models.DateTimeField(blank=True)),
                ('valor', models.TextField(blank=True)),
                ('documentoID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Documentos')),
